function [fi,dx,dy,ddx,ddy] = RBFIN(cloud,unkno)
...
stencil(2,1)=cloud(1,1)-stensize;
stencil(2,2)=cloud(2,1);
stencil(3,1)=cloud(1,1)+stensize;
stencil(3,2)=cloud(2,1);
stencil(4,1)=cloud(1,1)+2*stensize;
stencil(4,2)=cloud(2,1);
stencil(5,1)=cloud(1,1);
stencil(5,2)=cloud(2,1)-2*stensize;
stencil(6,1)=cloud(1,1);
stencil(6,2)=cloud(2,1)-stensize;
stencil(7,1)=cloud(1,1);
stencil(7,2)=cloud(2,1)+stensize;
stencil(8,1)=cloud(1,1);
stencil(8,2)=cloud(2,1)+2*stensize;
stencil(9,1)=cloud(1,1);
stencil(9,2)=cloud(2,1);
stencil=stencil';
figure(5)
