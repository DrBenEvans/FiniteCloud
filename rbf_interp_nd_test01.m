...
%
  ni = 1000;
  seed = 123456789;
  [ xi, seed ] = r8mat_uniform_ab ( m, ni, a, b, seed );
  fi = rbf_interp_nd ( m, nd, xd, r0, @phi1, w, ni, xi );
...
%
  ...
  ylabel ( '<--- Y --->' );
  zlabel ( '<---Z(X,Y)--->' );
  title ( 'Radial Basis Interpolant using PHI1(R)' )
%
